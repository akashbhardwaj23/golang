...
func (x *GeneratedReportResponse) Reset() {
	*x = GeneratedReportResponse{}
	mi := &file_proto_report_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GeneratedReportResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GeneratedReportResponse) ProtoMessage() {}

func (x *GeneratedReportResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_report_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GeneratedReportResponse.ProtoReflect.Descriptor instead.
func (*GeneratedReportResponse) Descriptor() ([]byte, []int) {
	return file_proto_report_proto_rawDescGZIP(), []int{1}
}

func (x *GeneratedReportResponse) GetReportId() string {
	if x != nil {
		return x.ReportId
	}
	return ""
...
func (x *GeneratedReportResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
const file_proto_report_proto_rawDesc = "" +
	...
	"\x17GeneratedReportResponse\x12\x1b\n" +
	...
	"\rReportService\x12P\n" +
	"\x0eGenerateReport\x12\x1d.report.GenerateReportRequest\x1a\x1f.report.GeneratedReportResponse\x12F\n" +
	"\vHealthCheck\x12\x1a.report.HealthCheckRequest\x1a\x1b.report.HealthCheckResponseB\tZ\a./protob\x06proto3"
...
var file_proto_report_proto_goTypes = []any{
	...
	(*GeneratedReportResponse)(nil), // 1: report.GeneratedReportResponse
...
var file_proto_report_proto_depIdxs = []int32{
	...
	1, // 2: report.ReportService.GenerateReport:output_type -> report.GeneratedReportResponse
