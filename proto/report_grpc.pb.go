...
type ReportServiceClient interface {
	GenerateReport(ctx context.Context, in *GenerateReportRequest, opts ...grpc.CallOption) (*GeneratedReportResponse, error)
...
func (c *reportServiceClient) GenerateReport(ctx context.Context, in *GenerateReportRequest, opts ...grpc.CallOption) (*GeneratedReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GeneratedReportResponse)
...
type ReportServiceServer interface {
	GenerateReport(context.Context, *GenerateReportRequest) (*GeneratedReportResponse, error)
...
func (UnimplementedReportServiceServer) GenerateReport(context.Context, *GenerateReportRequest) (*GeneratedReportResponse, error) {
